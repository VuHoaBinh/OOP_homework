...
public class Vehicle {
	...
	public static String getTieuDe() {
		return String.format("|%-20s|%-20s|%-20s|%-20s|%-20s|","CHU XE","LOAI XE","GIA TRI", "XYLANH","THUE");
	}
	...
	public String toString() {
		String kq = " ";
		kq+=String.format("|%-20s|%-20s|%-20f|%-20f|%-20f|",getChuXe(), getLoaiXe(), getXyLanh(), getTriGiaXe(), thue());
		return kq;
	}
